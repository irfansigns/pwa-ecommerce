...
const DefaultLayout =()=>{
    ...
    const handleMobileNavToggle = () => {
        ...
        // For example, if you want to toggle a class on the body element
        ...
        <div className="container-fluid">        
            <div className="row">
                ...
                <div className="logo col-4 col-sm-4 col-md-4 col-lg-3 align-self-center">
                    <a className="logoImg" href="index.html"><img src="assets/images/logo-white.png" alt="Hema Multipurpose Html Template" title="Hema Multipurpose Html Template" width="149" height="39" /></a>
                </div>
                                    ...
                                    <div class="row sp-row row-cols-lg-1 row-cols-md-1 row-cols-sm-1 row-cols-1">
                                        <div class="collection-item sp-col large-bnr">
                                            <a href="shop-left-sidebar.html" class="zoom-scal clr-none">
                                                <div class="img">
                                                    <img class="blur-up lazyload w-100" src="assets/images/collection/1007.jpg" alt="collection" title="" width="646" height="648" />
                                                </div>
                                ...
                                <div class="collection-banner-item">
                                    <div class="row sp-row row-cols-lg-2 row-cols-md-2 row-cols-sm-2 row-cols-2">
                                        <div class="collection-item sp-col">
                                            <a href="shop-left-sidebar.html" class="zoom-scal clr-none">
                                                <div class="img">
                                                    <img class="blur-up lazyload w-100" src="assets/images/collection/1006.jpg" alt="collection" title="" width="306" height="307" />
                                                </div>
                                        ...
                                        <div class="collection-item sp-col sale-banner">
                                            <a href="shop-left-sidebar.html" class="zoom-scal clr-none">
                                                <div class="img">
                                                    <img class="blur-up lazyload w-100" src="assets/images/collection/1008.jpg" alt="collection" title="" width="306" height="307" />
                                                </div>
                                                <div class="details middle-center text-center w-100">
                                                    <div class="inner">
                                                        <span class="small-title mb-2 mb-lg-2 d-block text-white text-uppercase">The Best Discount Ever</span>
                                                        <h3 class="title text-white">Sale <br/>70% OFF</h3>
                                                        <span class="btn btn-secondary btn-md mt-3 xs-hide">Shop Now</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>   
                                        <div class="collection-item sp-col">
                                            <a href="shop-left-sidebar.html" class="zoom-scal clr-none">
                                                <div class="img">
                                                    <img class="blur-up lazyload w-100" src="assets/images/collection/1009.jpg" alt="collection" title="" width="306" height="307" />
                                                </div>
                                                <div class="details bottom-center p-lg-0">
                                                    <div class="inner">
                                        ...
                                        <div class="collection-item sp-col">
                                            <a href="shop-left-sidebar.html" class="zoom-scal clr-none">
                                                <div class="img">
                                                    <img class="blur-up lazyload w-100" src="assets/images/collection/1011.jpg" alt="collection" title="" width="306" height="307" />
                                                </div>
                                                <div class="details bottom-center p-lg-0">
                                                    <div class="inner">
                        ...
                        {/* <div class="collection-slider-3items gp15 arwOut5 hov-arrow">
                            <div class="category-item zoomscal-hov">
                                <a href="shop-left-sidebar.html" class="category-link clr-none">
                                    <div class="zoom-scal zoom-scal-nopb"><img class="blur-up lazyload" src="assets/images/collection/1001.jpg" alt="collection" title="" width="420" height="521" /></div>
                            ...
                            <div class="category-item zoomscal-hov">
                                <a href="shop-left-sidebar.html" class="category-link clr-none">
                                    <div class="zoom-scal zoom-scal-nopb"><img class="blur-up lazyload" src="assets/images/collection/1002.jpg" alt="collection" title="" width="420" height="521" /></div>
                                    <div class="details mt-4 text-left d-flex align-items-start">
                                        <div class="pr-2">
                            ...
                            <div class="category-item zoomscal-hov">
                                <a href="shop-left-sidebar.html" class="category-link clr-none">
                                    <div class="zoom-scal zoom-scal-nopb"><img class="blur-up lazyload" src="assets/images/collection/1010.jpg" alt="collection" title="" width="420" height="521" /></div>
                                    <div class="details mt-4 text-left d-flex align-items-start">
                                        <div class="pr-2">
