                          ...
                          <div id="quickView" className="carousel slide">
                              ...
                              <div className="carousel-inner">
                                  <div className="item carousel-item active" data-bs-slide-number="0">
                                      <img className="rounded-0 blur-up lazyloaded" data-src={AppURL.Images+"/1011.jpg"} src={AppURL.Images+"/1011.jpg"} alt="product" title="Product" width="625" height="808" />
                                  </div>
                                  <div className="item carousel-item" data-bs-slide-number="1">
                                      <img className="rounded-0 blur-up lazyload" data-src={AppURL.Images+"/1011.jpg"} src={AppURL.Images+"/1011.jpg"} alt="product" title="Product" width="625" height="808" />
                                  </div>
                              ...
                              <div className="model-thumbnail-img">
                                  ...
                                  <div className="carousel-indicators list-inline">
                                      <div className="list-inline-item active" id="carousel-selector-0" data-bs-slide-to="0" data-bs-target="#quickView">
                                          <img className="rounded-0 blur-up lazyloaded" src={AppURL.Images+"/1001.jpg"} alt="product" title="Product" width="625" height="808" />
                                      </div>
