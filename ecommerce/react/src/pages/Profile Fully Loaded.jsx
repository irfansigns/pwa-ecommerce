      ...
      <div className="col-md-6">
        <div className="card mb-4 mb-md-0">
          <div className="card-body">
            ...
            <div className="progress rounded" style={px5}>
            ...
            <div className="progress rounded mb-2" style={px5}>
      ...
      <div className="col-md-6">
        <div className="card mb-4 mb-md-0">
          <div className="card-body">
            ...
            <p className="mb-1" style={{"fontSize" : ".77rem"}} >Web Design</p>
            <div className="progress rounded" style={{"height" : "5px"}}>
              <div className="progress-bar" role="progressbar" style={{"fontSize" : "10px", "height" : "100px", "width" : "100%" , "color" : ""}} aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
            <p className="mt-4 mb-1" style={{"fontSize" : ".77rem"}}>Website Markup</p>
            <div className="progress rounded" style={px5}>
              <div className="progress-bar" role="progressbar" style={{"width" : "72%"}} aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
