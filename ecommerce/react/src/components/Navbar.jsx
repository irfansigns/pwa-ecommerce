            ...
            <div className="select-wrap language-picker float-start">
              <ul className="default-option">
                <li>
                  <div className="option english">
                    <div className="icon">
                      <img src={AppURL.Images+'/flag/english.png'} alt="english" width="24" height="24" />
              ...
              <ul className="select-ul">
                <li>
                  <div className="option english">
                    <div className="icon">
                      <img src={AppURL.Images+'/flag/usd.png'} alt="english" width="24" height="24" />
                    </div>
                    <span>English</span>
                  </div>
                </li>
                <li>
                  <div className="option arabic">
                    <div className="icon">
                      <img src={AppURL.Images+'/flag/arabic.png'} alt="arabic" width="24" height="24" />
                    </div>
                    <span>Arabic</span>
                  </div>
                </li>
              ...
              <ul className="default-option">
                <li>
                  <div className="option USD">
                    <div className="icon">
                      <img src={AppURL.Images+'/flag/usd.png'} alt="usd" width="24" height="24" />
                    </div>
                    <span>USD</span>
                  </div>
                </li>
        ...
        <div className="container container-1330">
          <div className="row">
            ...
            <div className="logo col-4 col-sm-4 col-md-4 col-lg-3 col-xxl-3 align-self-center">
              ...
              <Link className="logoImg" to="/"><img src={AppURL.Images+'/logo/logo.png'} alt="Hema Multipurpose Html Template" title="Hema Multipurpose Html Template" width="149" height="39" /></Link>
            </div>
            {/* End Logo */}
            {/* Search Inline */}
