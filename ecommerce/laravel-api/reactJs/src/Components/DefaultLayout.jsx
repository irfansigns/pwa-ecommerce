        ...
        <div className="container-fluid">        
            <div className="row">
                ...
                <div className="logo col-4 col-sm-4 col-md-4 col-lg-3 align-self-center">
                    <a className="logoImg" href="index.html"><img src={axiosClient.Images+'/logo/logo-white.png'} alt="Hema Multipurpose Html Template" title="Hema Multipurpose Html Template" width="149" height="39" /></a>
                </div>
