                ...
                <div className="product-box">
                    ...
                    <div className="product-image">
                        ...
                        <Link to={"/details/"+product.id} className="product-img" tabIndex="0">
                            ...
                            <img className="primary blur-up lazyloaded"  src={axiosClient.Images+'/'+product.i_path} alt="Product" title="Product" width="625" height="703" />
                        
                            <img className="hover blur-up lazyloaded"  src={axiosClient.Images+'/'+product.i_path} alt="Product" title="Product" width="625" height="703" />
