...
const Cat1Slider = (props) => {
    ...
    useEffect(() => {
        const fetchImages = () => {
            ...
            axiosClient.MegaSlider(props.code).then(response=>{
    ...
    const sliderData = itemData.ProductData.map(slide=>{
        return(
            <div>
                    ...
                    <Link to={'/shop/'+props.cat}><img src={axiosClient.Images+"slider"+props.code+"/"+slide} className="card-img-top" alt="..." /></Link>
